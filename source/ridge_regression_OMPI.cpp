...
// **k-Fold Cross Validation with MPI & OpenMP**
void k_fold_cv_ompi(const MatrixXd &X, const VectorXd &y, double &best_alpha, double &best_rmse, VectorXd &best_beta, int k = 5) {
